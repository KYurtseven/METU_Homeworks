...
first_layer = tf.layers.dense(x, 4, activation = tf.nn.sigmoid)
second_layer = tf.layers.dense(first_layer, 3, activation = tf.nn.sigmoid)
output = tf.layers.dense(second_layer, 2, activation = tf.nn.softmax)
