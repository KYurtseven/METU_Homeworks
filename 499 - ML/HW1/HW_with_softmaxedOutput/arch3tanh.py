...
first_layer = tf.layers.dense(x, 8, activation = tf.nn.tanh)
second_layer = tf.layers.dense(first_layer, 4, activation = tf.nn.tanh)
third_layer = tf.layers.dense(second_layer, 3, activation = tf.nn.tanh)
